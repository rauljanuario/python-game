...
from src.Const import C_WHITE, WIN_HEIGHT, MENU_OPTION, EVENT_ENEMY, SPAWN_TIME, C_GREEN, C_CYAN, EVENT_TIMEOUT, \
...
class Level:
    def __init__(self, window: Surface, name: str, game_mode: str, player_score: list[int]):
        ...
        self.entity_list.extend(EntityFactory.get_entity(self.name + "p"))
    ...
    def run(self, player_score: list[int]):
        pygame.mixer_music.load(f'./assets/level.mp3')
